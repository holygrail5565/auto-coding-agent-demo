...
## ▶️ How to Run the AI Programming Experiment

After installation:

1. Open the auto-coding-agent-demo app.
2. You will see a simple main window with a "Start Experiment" button.
3. Click "Start Experiment" to begin the 10-hour AI coding session.
4. The AI will now work automatically. You can watch progress logs appear live.
5. You do not need to do anything else while it runs.
6. When done, the software will notify you that the experiment finished.
7. Results will save in the “output” folder inside the program directory.
